...
NONCE;
	 ...
	 */
	// The view file needs to pass a variable to both the name and value fields.
	// Compare both the nonce_html & the view_html to the actual html from the view file.
}