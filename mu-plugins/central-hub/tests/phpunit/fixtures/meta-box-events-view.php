<div class="event-date">
	...
	<p>
		<input id="event-date" type="date" name="events[event-date]" value="<?php echo $custom_fields['event-date']; ?>">
	</p>
...
<div class="event-time">
	...
	<p>
		<input id="event-time" type="time" name="events[event-time]" value="<?php echo $custom_fields['event-time']; ?>">
	</p>
	<p>
...
<div class="performance-venue">
	...
	<p>
		<input id="venue-name" class="large-text" type="text" name="events[venue-name]" value="<?php echo $custom_fields['venue-name']; ?>" placeholder="e.g. First Presbyterian Church of St. Louis">
	</p>
	<p>
