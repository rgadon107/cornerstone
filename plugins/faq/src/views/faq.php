<dt class="faq--visible" itemscope itemtype="http://schema.org/Question">
    <span class="faq--icon <?php echo $attributes['show_icon']; ?>" aria-hidden="true"
...
<dd class="faq--hidden" itemprop="suggestedAnswer" itemscope itemtype="http://schema.org/Answer"
