...
<div>
    ...
    <div>
        <input class="regular-text" type="text" placeholder="City"
               name="<?php echo $meta_box_id; ?>[review_location_city]"
               value="<?php echo esc_attr( $custom_fields['review_location_city'] ); ?>">
        <select name="<?php echo $meta_box_id; ?>[review_location_state]"
                value="<?php echo esc_attr( $custom_fields['review_location_state'] ); ?>">
...
<div>
    <p>
        ...
        <input class="large-text" type="text" placeholder="e.g. St. Mark's Episcopal Church"
               name="<?php echo $meta_box_id; ?>[event_venue]"
               value="<?php echo esc_attr( $custom_fields['event_venue'] ); ?>">
...
<div>
    <p>
        ...
        <input type="checkbox" name="<?php echo $meta_box_id; ?>[audience_review]"
               value="<?php echo esc_attr( $custom_fields['audience_review'] ); ?>">
...
<div>
    <p>
        ...
        <input type="date" name="<?php echo $meta_box_id; ?>[review_date]"
               value="<?php echo esc_attr( $custom_fields['review_date'] ); ?>">
...
<div>
    <p>
        ...
        <input class="large-text" type="text" name="<?php echo $meta_box_id; ?>[reviewer_name]"
               value="<?php echo esc_attr( $custom_fields['reviewer_name'] ); ?>">
...
<div>
    <p>
        ...
        <input class="large-text" type="text" name="<?php echo $meta_box_id; ?>[reviewer_title]"
               value="<?php echo esc_attr( $custom_fields['reviewer_title'] ); ?>">
...
<div>
    <p>
        ...
        <input class="large-text" type="text" name="<?php echo $meta_box_id; ?>[reviewer_org]"
               value="<?php echo esc_attr( $custom_fields['reviewer_org'] ); ?>">
