 ...
 *
 * @package     spiralWebDb\Cornerstone\Tests
 * @since       1.3.0
...
namespace spiralWebDb\Cornerstone\Tests;
...
function init_test_suite( $test_suite ) {
	...
	// Load the files.
	require_once CORNERSTONE_TESTS_ROOT_DIR . '/vendor/autoload.php';
	...
	require_once CORNERSTONE_TESTS_ROOT_DIR . '/vendor/antecedent/patchwork/Patchwork.php';
}
...
function check_readiness() {
	...
	if ( version_compare( phpversion(), '5.6.0', '<' ) ) {
		trigger_error( 'Unit Tests require PHP version 5.6 or higher.', E_USER_ERROR ); // phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_trigger_error -- Valid use case for our testing suite.
	}
...
function init_constants( $test_suite_folder ) {
	define( 'CORNERSTONE_TESTS_DIR', __DIR__ . DIRECTORY_SEPARATOR . $test_suite_folder );
	define( 'CORNERSTONE_TESTS_ROOT_DIR', dirname( __DIR__ ) );
	define( 'CORNERSTONE_ROOT_DIR', dirname( dirname( __DIR__ ) ) );
}
